<%@ Control Language="C#" AutoEventWireup="true" CodeFile="XsfxPlayerCut.ascx.cs" Inherits="HomoryPlayerCut" %>

<div id="a1" class="homory_player" style="width: 738px; height: 500px;margin: auto;"></div>
    ...
    */
    ...
    function addflash() {
        if (CKobject.Flash()['f']) {
            ...
            CKobject.embedSWF('../XsfxPlayer/XsfxPlayer/XsfxPlayer.swf', 'a1', 'ckplayer_a1', '600', '400', flashvars, params);
        }
        else {
