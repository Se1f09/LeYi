<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PdfViewer.aspx.cs" Inherits="Document.web.DocumentWebPdfViewer" %>
...
<body tabindex="1">
    <div id="outerContainer" class="loadingInProgress">
      ...
      <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight resHidden">
          <div id="secondaryToolbarButtonContainer">
            ...
            <a href="#" id="secondaryViewBookmark" class="secondaryToolbarButton bookmark visibleSmallView" title="当前视图（复制或在新窗口中打开）" tabindex="55" data-l10n-id="bookmark">
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <!-- <div class="toolbarButtonSpacer"></div> -->
                <a href="#" id="viewBookmark" class="toolbarButton bookmark hiddenSmallView" title="当前视图（复制或在新窗口中打开）" tabindex="35" data-l10n-id="bookmark">
                  <span data-l10n-id="bookmark_label">当前视图</span>
                </a>
                ...
                <div class="innerCenter" id="toolbarViewerMiddle">
                  ...
                  <span id="scaleSelectContainer" class="dropdownToolbarButton">
                     <select id="scaleSelect" title="Zoom" tabindex="23" data-l10n-id="zoom">
                      <option id="pageAutoOption" title="自动缩放" value="auto" selected="selected" data-l10n-id="page_scale_auto">自动缩放</option>
                      <option id="pageActualOption" title="实际大小" value="page-actual" data-l10n-id="page_scale_actual">实际大小</option>
                      <option id="pageFitOption" title="适合页面" value="page-fit" data-l10n-id="page_scale_fit">适合页面</option>
                      <option id="pageWidthOption" title="适合页宽" value="page-width" data-l10n-id="page_scale_width">适合页宽</option>
                      <option id="customScaleOption" title="自定义缩放" value="custom"></option>
