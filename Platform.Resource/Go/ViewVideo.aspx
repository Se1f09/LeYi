    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadWindowManager runat="server" ID="Rwm" Skin="Metro">
            <Windows>
                ...
                <telerik:RadWindow ID="popup_rate" Title="评分详情" runat="server" AutoSize="True" ShowContentDuringLoad="True" ReloadOnShow="True" KeepInScreenBounds="true" VisibleStatusbar="false" Behaviors="Close" Modal="True" Localization-Close="关闭" EnableEmbeddedScripts="True" EnableEmbeddedBaseStylesheet="True" VisibleTitlebar="True">
                </telerik:RadWindow>
            </Windows>
                                                ...
                                                <dl class="srx-comment-item">
                                                    ...
                                                    <dd>
                                                        ...
                                                        <div class="srx-comment-info">
                                                            <a target="_self" id="goReply" runat="server" onserverclick="goReply_OnServerClick">回复</a>&nbsp;&nbsp;<a target="_self" id="goDelP" runat="server" name='<%# Eval("Id").ToString() %>' onserverclick="goDelP_ServerClick" visible='<%# IsOnline &&  ((Homory.Model.ResourceComment)Container.DataItem).User.Id == CurrentUser.Id %>'>删除</a><br />
                                            ...
                                            <ItemTemplate>
                                                <li style="margin: 4px;">
                                                    <a href='<%# string.Format("../Go/Personal?Id={0}", U(Eval("Id3")).Id) %>'>
                                                        <asp:Image runat="server" ID="icon" ImageUrl='<%# U(Eval("Id3")).Icon %>' class="face face_40" Height="40" Width="40" /></a>
