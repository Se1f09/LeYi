...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadWindowManager runat="server" ID="Rwm" Skin="Metro">
            <Windows>
                <telerik:RadWindow ID="popup_rate" runat="server" Title="评分详情" AutoSize="True" ShowContentDuringLoad="True" ReloadOnShow="True" KeepInScreenBounds="true" VisibleStatusbar="false" Behaviors="Close" Modal="True" Localization-Close="关闭" EnableEmbeddedScripts="True" EnableEmbeddedBaseStylesheet="True" VisibleTitlebar="True">
                </telerik:RadWindow>
            </Windows>
