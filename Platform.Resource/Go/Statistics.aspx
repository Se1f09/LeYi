                                ...
                                <telerik:RadHtmlChart runat="server" ID="RadarAreaChart" Width="498" Height="498" Transitions="true" Skin="Silk" CssClass="sChart">
                                    <PlotArea>
                                        ...
                                        <XAxis Color="Black" MajorTickType="Outside" MinorTickType="Outside"
                                            ...
                                            <Items>
                                                <telerik:AxisItem LabelText="1月" />
                                                <telerik:AxisItem LabelText="2月" />
                                                <telerik:AxisItem LabelText="3月" />
                                                <telerik:AxisItem LabelText="4月" />
                                                <telerik:AxisItem LabelText="5月" />
                                                <telerik:AxisItem LabelText="6月" />
                                                <telerik:AxisItem LabelText="7月" />
                                                <telerik:AxisItem LabelText="8月" />
                                                <telerik:AxisItem LabelText="9月" />
                                                <telerik:AxisItem LabelText="10月" />
                                                <telerik:AxisItem LabelText="11月" />
                                                <telerik:AxisItem LabelText="12月" />
                                            </Items>
                                        </XAxis>
