...
<body class="srx-phome">
	<form runat="server">
		...
		<telerik:RadWindowManager runat="server" ID="Rwm" Skin="Metro">
			<Windows>
                <telerik:RadWindow ID="popup_push" runat="server" OnClientClose="pushPopped" Title="呈送" ReloadOnShow="True" Width="600" Height="300" Top="0" Left="0" ShowContentDuringLoad="True" VisibleStatusbar="false" Behaviors="Move,Close" Modal="True" CenterIfModal="False" Localization-Close="关闭">
				</telerik:RadWindow>
			</Windows>
