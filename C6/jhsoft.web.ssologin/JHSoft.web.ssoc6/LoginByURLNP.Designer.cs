...
{
	public class LoginByURLNP : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			else if (!this.Page.IsPostBack)
			{
				...
				string str1 = "";
				string str2 = "";
				if ((base.Request.Params["userid"] == null ? true : base.Request.Params["password"] == null))
				{
					MessageBox.ShowErr("登录失败，请重新登陆。", this.Page);
				}
				else
				{
					str1 = base.Request.Params["userid"].ToString();
					str = base.Request.Params["password"].ToString();
					str2 = "Yes";
				}
				if (!(str2 == "Yes"))
				{
				...
				else
				{
					...
					userID = role.GetUserID(str1.Trim());
					if (userID == null)
					{
