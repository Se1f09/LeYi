	...
	public partial class GoAuthorize : HomoryCorePageWithGrid
	{
        ...
        protected void view_OnNeedDataSource(object sender, RadListViewNeedDataSourceEventArgs e)
		{
            ...
            view.DataSource = departmentId.HasValue
				? list.OrderBy(o => o.Type).ThenBy(o => o.PriorOrdinal).ThenBy(o => o.RealName).ToList().Where(o => o.Account.Contains(stext) || o.RealName.Contains(stext) || o.Phone.Contains(stext) || o.IDCard.Contains(stext)).ToList()
                : null;
        }
