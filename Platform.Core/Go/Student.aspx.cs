...
namespace Go
{
    public partial class GoStudent : HomoryCorePageWithGrid
    {
        ...
        protected void view_NeedDataSource(object sender, RadListViewNeedDataSourceEventArgs e)
        {
            try
            {
                view.DataSource = ActionStudents.Join(HomoryContext.Value.ViewStudent, o => o, o => o.Id, (a, b) => b).OrderBy(o => o.RealName).ToList();
            }
            catch
            {
        ...
        protected void btnMove_Click(object sender, EventArgs e)
        {
            if (CurrentRights.Contains(HomoryCoreConstant.RightMoveUser))
            {
                ...
                if (node != null)
                {
                    ...
                    foreach (var asobj in ActionStudents.Join(HomoryContext.Value.ViewStudent, o => o, o => o.Id, (a, b) => b).OrderBy(o => o.RealName).ToList())
                    {
